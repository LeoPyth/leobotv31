 ...
 *Jawaban:* ${pickRandom(['Ya','Mungkin iya','Mungkin','Mungkin tidak','Tidak','Tidak mungkin'])} 
 ...
 handler.help = ['ɴᴜʀᴜᴛᴏᴍᴏ','ᴀᴅɪᴡᴀᴊsʜɪɴɢ','ʀᴇɴᴅʏᴄʀᴀғᴛ','ɪʙɴᴜ ɴʀ','ʙᴀᴋᴀ ʙᴏᴛᴢ', 'ᴀʀɪғғʙ25','ᴀᴛᴇɴᴀʙᴏᴛ','ʙᴀᴋᴀ ᴛᴇᴀᴍ','leo','ꜰᴏᴋᴜꜱ ɪᴅ','ᴋᴀɴɴᴀ','ᴛʜᴇ.ꜱᴀᴅ.ʙᴏʏ01','ᴀᴍɪʀᴜʟ','ɴᴜʀᴜᴛᴏᴍᴏ','ʙᴏᴄʜɪʟɢᴀᴍɪɴɢ','ᴀᴅɪᴡᴀᴊꜱʜɪɴɢ'] 
 handler.tags = ['thnks'] 
